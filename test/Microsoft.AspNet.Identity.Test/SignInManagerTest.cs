...
namespace Microsoft.AspNet.Identity.Test
{
    public class SignManagerInTest
    {
        ...
        public void ConstructorNullChecks()
        {
            ...
            Assert.Throws<ArgumentNullException>("contextAccessor", () => new SignInManager<IdentityUser>(userManager, null, null, null, null));
            var contextAccessor = new Mock<IContextAccessor<HttpContext>>();
            Assert.Throws<ArgumentNullException>("contextAccessor", () => new SignInManager<IdentityUser>(userManager, contextAccessor.Object, null, null, null));
