...
namespace Microsoft.AspNet.Identity.Test
{
    public static class MockHelpers
    {
        ...
        public static Mock<RoleManager<TRole>> MockRoleManager<TRole>() where TRole : class
        {
            ...
            return new Mock<RoleManager<TRole>>(store.Object, roles, null, null);
        }
        ...
        public static Mock<ILoggerFactory> MockILoggerFactory(Mock<ILogger> logger = null)
        {
            logger = logger ?? MockILogger();
            var loggerFactory = new Mock<ILoggerFactory>();
            loggerFactory.Setup(x => x.Create(It.IsAny<string>())).Returns(logger.Object);
