...
namespace Microsoft.AspNet.Identity.Test
{
        ...
        where TKey : IEquatable<TKey>
    {
        protected virtual void SetupIdentityServices(IServiceCollection services, object context = null)
        {
            ...
            services.AddInstance<ILoggerFactory>(new TestFileLoggerFactory());
        ...
        public async Task UserValidatorCanBlockCreate()
        {
            ...
            IdentityResultAssert.VerifyUserManagerFailureLog(manager.Logger, "CreateAsync", (await manager.GetUserIdAsync(user)).ToString(), AlwaysBadValidator.ErrorMessage);
        }
